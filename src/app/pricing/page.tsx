      ...
      <main className="min-h-screen">
        ...
        <Container>
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 xl:gap-2 2xl:gap-5">
            ...
            <div className="lg:-mt-8">
              <p className="text-[13px] leading-4 text-center py-2 bg-blurple rounded-t-md font-medium">
                Recommended
              </p>
              <Box className="!border-blurple !border-2 !rounded-t-none">
                <h3 className="font-mono text-2xl font-normal uppercase text-primary">
                  Supporter
                </h3>
                <p className="my-4 border-b border-neutral-100/10 pb-4 text-sm text-neutral-300">
        ...
        <Container className="py-16 md:py-24">
          <div className="text-center">
            <h2
              id="compare-plans"
              className="text-neutral-100 text-3xl scroll-m-20"
            >
              Compare Plans
            </h2>
